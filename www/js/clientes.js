...
//Funcion que guarda en un arreglo el snpashot de los clientes
function initApp() {
...
//Funcion que imprimer con el inner html el arreglo pasado
function printClients(arr){
    var goingToPrint=" ";
    for(var i=0; i<arr.length; i++){
      //Aqui se van pegando en el string todo el html
    ...
    //Se comenta la estructura para tener una idea de como hacer el inner html
    /*
        <div class="container">
        <div class="row">
